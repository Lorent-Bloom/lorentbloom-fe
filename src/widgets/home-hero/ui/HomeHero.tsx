...
export default async function HomeHero({ className }: HomeHeroProps) {
  ...
  return (
    <section
      className={cn(
        "relative min-h-screen flex items-start md:pt-0 md:items-center overflow-hidden",
        className,
      )}
    >
      {/* Background Image */}
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 pt-0 pb-20 md:py-20 -mt-16 md:mt-0">
