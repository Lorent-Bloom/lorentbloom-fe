...
export const useCategoryShowcase = (categories: Category[], locale: string) => {
  ...
  const displayCategories = useMemo(() => {
    ...
    const baseCategories =
      level2Categories.length > 0 ? level2Categories : FALLBACK_CATEGORIES;
