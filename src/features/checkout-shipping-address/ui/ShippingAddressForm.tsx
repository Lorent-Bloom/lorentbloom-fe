...
import { useShippingAddressForm } from "../lib/useShippingAddressForm";
import type { ShippingAddressFormProps } from "../model/interface";
...
export default function ShippingAddressForm({
  ...
  const { form, handleSubmit } = useShippingAddressForm(onSubmit, isSubmitting);
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className={className}>
        ...
        <Button type="submit" className="mt-6 w-full" disabled={isSubmitting}>
          {isSubmitting ? t("saving") : t("save_shipping_address")}
        </Button>
      </form>
    </Form>
  );
